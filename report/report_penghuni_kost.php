...
$objPHPExcel->getSheet(0)
            ->setCellValue('A1', 'DATA PENGHUNI RUMAH KOST')
            ...
            ->setCellValue('B6', $nama_kost);


            include '../config/koneksi.php';
            $query = mysqli_query($conn, "SELECT * FROM penghuni_kost WHERE nama_kost = '$nama_kost' AND nama_pemilik = '$pemilik' AND alamat = '$alamat'");
            $baris = 9;
            $no = 1;
...
header('Content-Disposition: attachment;filename="laporan_penghuni_kost.xls"');
