<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $raw = file_get_contents('http://abu.lineupdev.com/tegalparang/config/getDataPenghuniKontrakanJson.php?page=' . $page . "&alamat_kontrakan=" . urlencode($_POST['alamat_kontrakan']));
