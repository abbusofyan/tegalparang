<?php
	...
	if($_POST['rowid']){
		$id = $_POST['rowid'];
      $query = mysqli_query($conn, "SELECT * FROM penghuni_kontrakan WHERE u_id = '$id'");
      while ($row = mysqli_fetch_assoc($query)) {
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_penghuni" name="nama_penghuni" value="<?php echo $row['nama_penghuni']; ?>">
            </div>
			<div class="form-row">
                        <div class="col-md-6 mb-3">
                        <label>Tempat lahir</label>
                        <input type="text" name="tempat_lahir" id="tempat_lahir" value="<?php echo $tempat_lahir; ?>" class="form-control" required>
                        ...
                        <input type="date" name="tgl_lahir" id="tgl_lahir" value="<?php echo $tgl_lahir; ?>" class="form-control" required>
						<div class="invalid-feedback">
			...
			<div class="form-group">
                ...
                <input type="text" id="alamat_ktp" class="form-control" name="alamat_ktp" value="<?php echo $row['alamat_ktp']; ?>">
						...
						<div class="form-group" id="no_itas">
							...
							<input type="file" name="foto" id="foto" onchange="PreviewImage()" class="form-control"/>
						</div>
...
document.querySelector('#foto').addEventListener('change', function(e) {
  ...
  xhr.open('POST', 'config/ganti_foto_penghuni_kontrakan.php', true);
		...
		bootbox.dialog({
			...
			buttons: {
				...
				danger: {
					...
					callback: function () {
						$.post('config/editDataPenghuniKontrakan.php', {
								u_id: u_id,
