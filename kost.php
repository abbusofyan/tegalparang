...
<body>
	<div class="header">
      ...
      <a href="#"></a> <img src="<?php echo $foto; ?>" class="profile-pic" id="profileMenu" alt="Profile">
			...
			<a class="nav-link active" href="kost.php">Input data rumah kost</a>
	...
	<div class="container">
		<div class="row">
			<h3 class="title">Input data rumah kost di Kel. Tegal parang</h3>
			<br>
		</div>
	</div>
	<div id="main">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<form class="needs-validation" novalidate method="post" id="frm_input" action="config/input_kost.php" enctype="multipart/form-data">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Alamat</label>
								<input type="text" class="form-control" placeholder="masukkan nama jalan, dan No. rumah" name="alamat" required>
							...
							<div class="form-group col-md-2">
								<label>RT</label>
								<input type="text" class="form-control" value="<?php echo $_SESSION['rt']; ?>" name="rt" readonly>
							</div>
							<div class="form-group col-md-2">
								<label>RW</label>
								<input type="text" class="form-control" value="<?php echo $_SESSION['rw']; ?>" name="rw" readonly>
							</div>
						</div>
						<div class="form-group">
							<label>Pemilik</label>
							...
							<div class="invalid-feedback">
								Field nama pemilik wajib diisi.
							</div>
						</div>
						<div class="form-group">
							<label>NIK pemilik</label>
							<input type="text" onkeypress="return hanyaAngka(event)" class="form-control" name="nik" required>
							<div class="invalid-feedback">
						...
						<div class="form-group" id="no_izin_kost">
							...
							<input id="input_no_izin_kost" type="text" onkeypress="return hanyaAngka(event)" class="form-control"
							 placeholder="masukkan no. izin kost" name="no_izin_kost" id="no_izin_kost">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>upload foto rumah kost</label>
						...
						<button class="btn btn-primary btn-lg btn-block mb-4 mt-3" type="submit">Submit data kost</button>
					</form>
				</div>
			</div>
		</div>
